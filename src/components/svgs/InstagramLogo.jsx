    ...
    return (
      ...
      >
        <g fillRule="nonzero">
          ...
          <path
            fill="url(#_Linear3)"
            d="M423.372 119.346c0 16.967-13.754 30.72-30.72 30.72s-30.72-13.753-30.72-30.72c0-16.966 13.754-30.719 30.72-30.719s30.72 13.753 30.72 30.719z"
          ></path>
        </g>
        <defs>
          <linearGradient
            ...
            y1="0"
            y2="0"
            gradientTransform="scale(-516.448) rotate(-73.16 -.256 .419)"
            gradientUnits="userSpaceOnUse"
          >
            <stop offset="0" stopColor="#515bd4"></stop>
            <stop offset="0.26" stopColor="#9510b8"></stop>
            <stop offset="0.66" stopColor="#e51804"></stop>
            <stop offset="1" stopColor="#feda77"></stop>
          </linearGradient>
          <linearGradient
            id="_Linear2"
            x1="0"
          ...
          >
            ...
            <stop offset="0.26" stopColor="#9510b8"></stop>
            <stop offset="0.66" stopColor="#e51804"></stop>
            <stop offset="1" stopColor="#ffbf00"></stop>
          </linearGradient>
          <linearGradient
            id="_Linear3"
            x1="0"
